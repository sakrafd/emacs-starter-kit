...
(setq dfarkas-js-imenu-generic-expression
...
(add-hook 'javascript-mode-hook
          (lambda ()
            (setq imenu-generic-expression dfarkas-js-imenu-generic-expression)
            (setq indent-region-function dfarkas-js-beautify)))
